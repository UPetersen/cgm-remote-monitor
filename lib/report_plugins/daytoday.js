  ...
  d3.select('body').append('svg')
    ...
    if (options.scale === report_plugins.consts.SCALE_LOG) {
      yScale2 = d3.scale.log()
        .domain([client.utils.scaleMgdl(options.basal ? 30 : 36), client.utils.scaleMgdl(280)]);
    } else {
      yScale2 = d3.scale.linear()
        .domain([client.utils.scaleMgdl(options.basal ? -40 : 36), client.utils.scaleMgdl(280)]);
    }
      ...
      sel.attr('cx', function (d) { 
        return xScale2(d.date) + padding.left; 
          ...
          .attr('cy', function (d) {
            if (isNaN(d.sgv)) {
                badData.push(d);
                return yScale2(client.utils.scaleMgdl(310) + padding.top);
            } else {
...
//        }
        ...
        context.append('rect')
          ...
          .attr('y', yScale2(client.utils.scaleMgdl(256)) + padding.top)
          .attr('width', xScale2(treatment.mills + times.mins(treatment.duration).msecs) - xScale2(treatment.mills))
          .attr('height', yScale2(client.utils.scaleMgdl(220)) - yScale2(client.utils.scaleMgdl(256)))
          .attr('stroke-width', 1)
          .attr('opacity', .2)
          .attr('stroke', 'white')
          .attr('fill', 'Violet');
        context.append('text')
          ...
          .attr('text-anchor', 'middle')
          .attr('dy', '.35em')
          .attr('y', yScale2(client.utils.scaleMgdl(238)) + padding.top)
...
//          .attr('width', xScale2(treatment.mills + times.mins(treatment.duration).msecs) - xScale2(treatment.mills))
//          .attr('height', yScale2(client.utils.scaleMgdl(184)) - yScale2(client.utils.scaleMgdl(220)))
//          .attr('stroke-width', 1)
//          .attr('opacity', .2)
//          .attr('stroke', 'white')
//          .attr('fill', 'Salmon');
...
//        context.append('rect')
//          .attr('x', xScale2(treatment.mills) + padding.left)
//          .attr('y', yScale2(client.utils.scaleMgdl(184)) + padding.top)
//          .attr('width', xScale2(treatment.mills + times.mins(treatment.duration).msecs) - xScale2(treatment.mills))
//          .attr('height', yScale2(client.utils.scaleMgdl(238)) - yScale2(client.utils.scaleMgdl(184)))
//          .attr('stroke-width', 1)
//          .attr('opacity', .2)
//          .attr('stroke', 'white')
//          .attr('fill', 'Brown');
...
//          .attr('text-anchor', 'middle')
//          .attr('dy', '.35em')
//          .attr('y', yScale2(client.utils.scaleMgdl(166)) + padding.top)
//          .attr('x', xScale2(treatment.mills + times.mins(treatment.duration).msecs/2) + padding.left)
//          .text(treatment.notes);
...
//        context.append('rect')
//          .attr('x', xScale2(treatment.mills) + padding.left)
//          .attr('y', yScale2(client.utils.scaleMgdl(292)) + padding.top)
//          .attr('width', xScale2(treatment.mills + times.mins(treatment.duration).msecs) - xScale2(treatment.mills))
//          .attr('height', yScale2(client.utils.scaleMgdl(256)) - yScale2(client.utils.scaleMgdl(292)))
//          .attr('stroke-width', 1)
//          .attr('opacity', .2)
//          .attr('stroke', 'white')
//          .attr('fill', 'black');
